...
class TransferActivity : Activity() {
    ...
    companion object {
        const val ACTION_FROM_SELF = "com.ysy.actrecog.ka.c.TransferActivity.FROM_SELF"
        const val ACTION_FROM_OTHER = "com.ysy.actrecog.ka.c.TransferActivity.FROM_OTHER"
        private const val TAG = "TEST-1-C-TransferActivity"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null) {
            if (ACTION_FROM_OTHER == intent.action) {
                ...
                startActivity(Intent("com.ysy.actrecog.ka.s.TransferActivity.FROM_OTHER").apply {
                    flags = Intent.FLAG_ACTIVITY_NEW_TASK
                    component = ComponentName("com.ysy.actrecog", "com.ysy.actrecog.ka.s.TransferActivity")
                })
            }
        }
    }
